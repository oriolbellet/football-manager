...
class CreateMatchController(private val createMatchUseCase: CreateMatchUseCase,
    ...
    data class CreateMatchRequestDto(val homeTeamId: String, val awayTeamId: String)
